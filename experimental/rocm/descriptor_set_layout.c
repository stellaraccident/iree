...
extern const iree_hal_descriptor_set_layout_vtable_t iree_hal_rocm_descriptor_set_layout_vtable;

static iree_hal_rocm_descriptor_set_layout_t *iree_hal_rocm_descriptor_set_layout_cast(
...
iree_status_t iree_hal_rocm_descriptor_set_layout_create(iree_hal_rocm_context_wrapper_t *context,
  ...
  *out_descriptor_set_layout = NULL;
  ...
  iree_status_t status =
    iree_allocator_malloc(context->host_allocator, sizeof(*descriptor_set_layout), (void **)&descriptor_set_layout);
  if (iree_status_is_ok(status)) {
    iree_hal_resource_initialize(&iree_hal_rocm_descriptor_set_layout_vtable, &descriptor_set_layout->resource);
...
static void iree_hal_rocm_descriptor_set_layout_destroy(iree_hal_descriptor_set_layout_t *base_descriptor_set_layout) {
  ...
  iree_allocator_t host_allocator = descriptor_set_layout->context->host_allocator;
  IREE_TRACE_ZONE_BEGIN(z0);
...
const iree_hal_descriptor_set_layout_vtable_t iree_hal_rocm_descriptor_set_layout_vtable = {
