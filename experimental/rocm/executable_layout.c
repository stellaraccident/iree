...
extern const iree_hal_executable_layout_vtable_t iree_hal_rocm_executable_layout_vtable;
...
iree_status_t iree_hal_rocm_executable_layout_create(iree_hal_rocm_context_wrapper_t *context,
                                                     iree_host_size_t set_layout_count,
                                                     iree_hal_descriptor_set_layout_t **set_layouts,
  ...
  *out_executable_layout = NULL;
  ...
  iree_host_size_t total_size = sizeof(*executable_layout) + set_layout_count * sizeof(*executable_layout->set_layouts);
  iree_status_t status = iree_allocator_malloc(context->host_allocator, total_size, (void **)&executable_layout);
  if (iree_status_is_ok(status)) {
    iree_hal_resource_initialize(&iree_hal_rocm_executable_layout_vtable, &executable_layout->resource);
...
static void iree_hal_rocm_executable_layout_destroy(iree_hal_executable_layout_t *base_executable_layout) {
  iree_hal_rocm_executable_layout_t *executable_layout = iree_hal_rocm_executable_layout_cast(base_executable_layout);
...
const iree_hal_executable_layout_vtable_t iree_hal_rocm_executable_layout_vtable = {
